...
> **Status:** Project Structure Initialized (Kotlin Mobile + Python Desktop + Firebase Database)  
...
│   ├── firebase_config.py         # Firebase Admin SDK initialization & helper queries
